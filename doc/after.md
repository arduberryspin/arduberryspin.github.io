...
11월 27일
아두베리스핀 파트4-5 스터디 후기
없는문서도 만들어 채워넣는다는 전설의 문서지기입니다
이번 스터디는 물리 모델링을 통한 유니티 로켓 만들기였습니다.
재사용 가능한 로켓 발사에서 영감을 얻어 유니티를 통하여
물리 모델링 로켓을 만들고 시물레이션 실습을 하였습니다
목표는 10m 상공 까지 로켓을 발사 한후 다시 착륙을 시도합니다.
5m 상공 부터 감속하여 지면에 소프트하게 안착하면 성공 지면과 충돌시 가속도가 2 m/s2 이하로 착륙하게 하면 성공.
세게 착륙하면 로켓이 폭파.
중력가속도와 로케수무게를 고려하여 y축방향으로 가속 감속 계산을
프로그래밍하여 안정적으로 로켓 운영을 작성하는것이 포인트였습니다.
Young Sook Song님도 복붙(copy&paste)기술을 발휘하여 로켓을 날리는데 성공을 하셨습니다
도장신공과 우주 넘어로 홈런 신공을 덤으로 얻으셨습니다
다음 스터디도 기대가 됩니다.
스터디 진행해주신 YunKyu Choi님께 무한한 감사 드립니다.
재사용 로켓 동영상
